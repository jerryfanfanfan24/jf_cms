<template>
  <div class="dashboard">
    ...
    <el-row :gutter="10">
      <el-col :span="7">
        <chart-card>
          <pie-echart :pieData="showGoodsCategoryCount"></pie-echart>
        </chart-card>
      </el-col>
      <el-col :span="10">
        <chart-card
      ...
      <el-col :span="7">
        <chart-card>
          <rose-echart :roseData="showGoodsCategoryCount"></rose-echart>
        </chart-card>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="10">
      <el-col :span="12"
        ><chart-card>
          ...
          ></line-echart> </chart-card
      ></el-col>
      <el-col :span="12"
        ><chart-card>
          <bar-echart v-bind="showGoodsCategoryFavor"></bar-echart> </chart-card
      ></el-col>
    </el-row>
  </div>
</template>
